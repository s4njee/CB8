...
/**
 * Strip a leading YYYY / YYYYMM / YYYYMMDD release-date prefix from a filename
 * (or filename-derived title). Used both by the series parser and by the
 * ingest service when computing the display title, so a file like
 * "199305 X-Force v1 022.cbz" shows as "X-Force v1 022" instead of
 * "199305 X-Force v1 022".
 */
