/**
 * safeFetch.ts — fetch remote resources with SSRF guards and bounded size.
 *
 * Prevents the admin cover-URL import (and any future remote fetch) from
 * being used to hit private network ranges, hang on slow hosts, or download
...
/**
 * Fetch a remote URL with:
 *  - scheme restricted to https: (unless explicitly opted out of)
 *  - hostname + resolved IPs checked against private/loopback ranges
