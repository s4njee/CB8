/// Importing files into the on-device library: the file picker / drag-and-drop
/// entry points, and the shared probe-and-insert ingest pipeline.
///
/// Downloading items *from a server* for offline use lives in
...
class ImportController extends Notifier<ImportState> {
  ...
  /// Catalog row for a freshly imported local file, merging the probe's
  /// embedded metadata over filename heuristics.
